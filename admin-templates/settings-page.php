...
printf(
	'<a href="#sending" class="nav-tab" data-tab="sending">%s</a>',
	esc_html__( 'Sending', 'heads-up-mailer' )
);
printf(
...
printf( '<div id="sending-panel" class="tab-panel" style="display:none;">' );
require __DIR__ . '/tab-sending.php';
printf( '</div>' );
